...
f_path_o = f"/home/jfeltman/data/test_funcs/{freq}hz_{amp}amp_{t_max}s_o.csv"
...
# read the out file and plot it
dfft = np.loadtxt(f_path_o, delimiter=',')
dfft_axis = np.linspace(0, 1, num=dfft.shape[0])
fig, ax = plt.subplots()
ax.plot(dfft_axis, dfft[:, 0])
plt.show()